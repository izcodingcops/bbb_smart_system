...
import {ambassadorResolvers} from './features/ambassador/resolvers';
...
import {offHoursVisitResolvers} from './features/offHoursVisit/resolvers';
...
import {shiftNoteResolvers} from './features/shiftNote/resolvers';
...
export const mockSchema = makeExecutableSchema({
  ...
  resolvers: {
    ...
    Query: {
      ...
      ...offHoursVisitResolvers.Query,
      ...shiftNoteResolvers.Query,
      ...ambassadorResolvers.Query,
    },
    Mutation: {
